...
fio --filename=/dev/nvme3n1 --rw=write --bs=128k --iodepth=32 --ioengine=libaio --direct=1 --name=volume-initialize | tee nvme2n1-init.txt &
fio --filename=/dev/nvme4n1 --rw=write --bs=128k --iodepth=32 --ioengine=libaio --direct=1 --name=volume-initialize | tee nvme2n1-init.txt &
